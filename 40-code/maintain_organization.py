...
class AcademicStructureValidator:
    ...
    def __init__(self, base_path: Path, dry_run: bool = False):
        ...
        # Academic directory structure (follows 00-90 taxonomy)
        self.required_dirs = {
            '10-knowledge': {
                'literature': 'Academic papers, references, and research materials',
        ...
        # Files that should have README.md (updated for academic taxonomy)
        self.readme_dirs = [
            '10-knowledge', '10-knowledge/literature', '10-knowledge/methods',
            '10-knowledge/applications', '10-knowledge/notes',
            '20-projects', '20-projects/active', '20-projects/completed', '20-projects/archived',
    ...
    def find_misplaced_files(self) -> List[Path]:
        ...
        # Exclude TODO.md and TASKS.md as they are intentionally at root level
        root_md_files = [
            f for f in self.base_path.glob("*.md")
            if f.name not in self.required_root_files + ['CONTRIBUTING.md', 'TODO.md', 'TASKS.md']
        ]
